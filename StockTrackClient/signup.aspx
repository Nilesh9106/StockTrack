<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="StockTrackClient.signup" MasterPageFile="~/Site.Master" %>

<asp:Content ContentPlaceHolderID="head" runat="server">
    <title>Signup | StockTrack</title>
</asp:Content>
...
<asp:Content ContentPlaceHolderID="body" runat="server">
    <div class="my-5 table-responsive">
        ...
        <table align="center" class="w-100 table table-hover">
            <tr>
                <td>
                    <asp:Label ID="usernameLabel" runat="server" AssociatedControlID="usernameInput" CssClass="form-label" Text="Name"></asp:Label>
                </td>
                <td>
